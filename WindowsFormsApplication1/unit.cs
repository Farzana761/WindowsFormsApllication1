...
namespace WindowsFormsApplication1
{
    ...
    public class unit
    {
        ...
        {
            bool r = ob.entrybusdata(7, "Asia", "Dhaka", "Comilla", "16/12/2018", "6:00pm", "9:00pm", 40, 250);
            Assert.IsTrue(r);
        }
        [Test]
        ...
        {
            bool r = ob.updatebusdata(7, "Asia", "Dhaka", "Comilla", "20/12/2018", "6:00pm", "9:00pm", 40, 250);
            Assert.IsTrue(r);
        }
        [Test]
